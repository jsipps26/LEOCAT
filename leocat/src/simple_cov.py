...
class SimpleCoverage:
	...
	# def compute_coverage_fast(self, dt=None, f=0.25, verbose=1, solar_band=None, \
	# 					warn=True, spherical=False):
	# 	#
	# 	from leocat.src.at import get_access_bounds, t_seg_to_t_test
	...
	# 	access = {}
	# 	for j in iterator:
	# 		t_seg = get_access_bounds(orb, swath, lon, lat, JD1, JD2)
	# 		t = t_seg_to_t_test(t_seg, dt, t0=0.0)
	# 		JD = JD1 + t/86400
	# 		r_eci_sc, v_eci_sc = orb.propagate(t)
	# 		r_ecf_sc, v_ecf_sc = convert_ECI_ECF(JD, r_eci_sc, v_eci_sc)
